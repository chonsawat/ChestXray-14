...
for fold_num in range(1, NUM_FOLDS + 1):
    ...
    # Model Checkpoint
    model_checkpoint_callback = ModelCheckpoint(f'{ROOT_PATH}/results/models/{NAME}_{weight_option}_fold_{fold_num}.h5', monitor='val_loss', mode='min', save_best_only=True)
    ...
    # CSV Logger
    path = os.path.join(ROOT_PATH, "results", "history", f"{NAME}_{weight_option}")
