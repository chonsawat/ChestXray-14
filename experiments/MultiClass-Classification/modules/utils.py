...
def _serialize_sample(image_id, image, proba):
    feature = {
        ...
        'Infiltration': tf.train.Feature(int64_list=tf.train.Int64List(value=[proba[0]])),
        'Effusion': tf.train.Feature(int64_list=tf.train.Int64List(value=[proba[1]])),
        'Atelectasis': tf.train.Feature(int64_list=tf.train.Int64List(value=[proba[2]])),
        'No Finding': tf.train.Feature(int64_list=tf.train.Int64List(value=[proba[3]])),
    }
